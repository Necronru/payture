...
$response = $eWallet->payment()->init(new InitCommand(SessionType::PAY, 'http://localhost?order={orderid}&success={success}', '123@ya.ru', '2645363', '98.132.229.220', uniqid('test_'), 500, '79001234567'));
